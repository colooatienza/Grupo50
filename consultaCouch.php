<!DOCTYPE html>
<head>
<link rel="stylesheet" href="../CouchInn/css/bootstrap.css">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Consulta Couch</title>
<style type="text/css" media="screen">
  @import '../CouchInn/estilo/estiloConsultaCouch.css';> 
</style>
<script src="../CouchInn/js/jquery-1.11.3.min.js"></script> 
<script src="../CouchInn/js/bootstrap.js"></script>
</head>
...
<body >
	...
	<?php
    session_start();
    include("../CouchInn/conexion.php");
    include("../CouchInn/menu.php");
