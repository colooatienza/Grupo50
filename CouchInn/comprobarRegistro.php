...
$i=$i+strlen($dominio)+1;
  ...
  if (copy($_FILES['archivo']['tmp_name'],$destino1)) {
   ...
   $status = "Error al subir el archivo";}
						...
						$sql3 = ("INSERT INTO usuarios(nombredeusuario, clave, nacionalidad, fechadenacimiento,sexo,mail,telefono,celular,descripcion,foto) VALUES ('$usuario', '$clave','$nacionalidad','$fecha','$sexo','$email','$telefono','$telefono_movil','$descripcion','$destino')");
